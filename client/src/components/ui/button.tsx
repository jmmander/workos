...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap hover:brightness-95 disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 border aria-invalid:ring-destructive/20 aria-invalid:border-destructive focus-ring transition-all duration-150",
  {
    variants: {
      variant: {
        default:
          'bg-primary hover:bg-primary-hover text-primary-foreground border-button-border disabled:bg-primary-disabled disabled:text-primary-foreground disabled:border-primary-disabled active:brightness-90',
        destructive:
      ...
      size: {
        compact:
          'h-6 px-2 rounded-[3px] text-xs leading-4 font-medium text-center',
        default:
          'px-3 py-2 rounded font-medium text-sm leading-5 text-center h-8',
