...
export function useTabData({
  ...
  const usersActions = useMemo(() => createUsersActions(handleEditUser, handleDeleteUser), [handleEditUser, handleDeleteUser])
  const rolesActions = useMemo(() => createRolesActions(handleEditRole, handleDeleteRole), [handleEditRole, handleDeleteRole])
  ...
  return useMemo(() => ({
    ...
    currentHandlePageChange: isUsers ? handlePageChange : handleRolesPageChange,
    currentHandleQueryChange: isUsers ? handleQueryChange : handleRolesQueryChange,
    ...
    isUsers, activeTab, users, roles, usersLoading, rolesLoading, usersError, rolesError,
    page, rolesPage, query, rolesQuery, usersActions, rolesActions,
    handlePageChange, handleRolesPageChange, handleQueryChange, handleRolesQueryChange
  ])
}
